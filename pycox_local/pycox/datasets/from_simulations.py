...
import numpy as np
import pandas as pd
from pycox_local.pycox import simulations
...
class _RRNLNPH(_SimDataset):
    ...
    To generate more data:
        >>> from pycox_local.simulations import SimStudyNonLinearNonPH
        >>> n = 10000
...
class _SAC3(_SimDataset):
    ...
    To generate more data:
        >>> from pycox_local.simulations import SimStudySACCensorConst
        >>> n = 10000
...
class _SACAdmin5(_SimDataset):
    ...
    To generate more data:
        >>> from pycox_local.simulations import SimStudySACAdmin
        >>> n = 10000
