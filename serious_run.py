...
if __name__ == '__main__':
    ...
    if  args['net_type'] in ['cox_time_benchmark','deepsurv_benchmark','cox_CC_benchmark','cox_linear_benchmark','deephit_benchmark']:
        ...
        dataset_bs = [[25, 50, 100, 250], [5, 10, 25, 50, 100], [5, 10, 25, 50, 100], [5, 10, 25, 50, 100], [1028],
                      [64, 128, 256, 512, 1024], [64, 128, 256, 512, 1024], [64, 128, 256, 512, 1024]]
        dataset_d_x = [[1, 2], [1, 2], [1, 2], [1, 2], [4, 6, 8], [1, 2], [1, 2], [1, 2]]
        dataset_d = [[1, 2], [1, 2], [1, 2], [1, 2], [1, 2,4], [1, 2, 4], [1, 2, 4], [1, 2, 4]]
        dataset_w_x = [[16, 32], [16, 32], [16, 32], [16, 32], [64,128, 256, 512], [8, 16, 32, 64], [8, 16, 32, 64],
                       [8, 16, 32, 64]]
        dataset_w = [[16, 32], [8, 16, 32], [8, 16, 32], [8, 16, 32], [64,128, 256, 512], [8, 16, 32, 64], [8, 16, 32, 64],
                     [8, 16, 32, 64]]
